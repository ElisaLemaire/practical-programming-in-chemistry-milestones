...
| 1    | Create a New Branch                         | https://github.com/ElisaLemaire/README/tree/new-branch-name            |
| 1    | Create a conda environment                  | https://github.com/ElisaLemaire/`repo-name`/blob/`branch-name`/`env.yml`      |
